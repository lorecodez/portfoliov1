    ...
    return (
        <div>
            ...
            <article className="py-9">
                ...
                <section>
                    <p className="px-2 first-letter:font-serif first-letter:text-5xl first-letter:font-bold first-letter:bg-gradient-to-r from-orange-400 via-red-500 to-purple-600 first-letter:bg-clip-text first-letter:text-transparent first-letter:drop-shadow first-letter:mr-3 first-letter:float-left first-letter:mt-2.5">
